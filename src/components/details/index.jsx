      ...
      <div className="details-one-product">
        ...
        <section>
          ...
          <div className="details-btn">
            <button
              className={isActive === 0 ? 'active-btn-details' : 'btn-details'}
              onClick={() => setIsActive(0)}
            >
              Product
            </button>
            <button
              className={isActive === 1 ? 'active-btn-details' : 'btn-details'}
              onClick={() => setIsActive(1)}
            >
              Details
            </button>
            <button
              className={isActive === 2 ? 'active-btn-details' : 'btn-details'}
            ...
            >
              {user && user.role !== 'merchant' && (
                <div style={{ width: '100%' }} ref={ref}>
                  <button
                    style={{ display: isAdd || isActiveMassage? 'none' : 'block' }}
                    onClick={addSuccsess}
